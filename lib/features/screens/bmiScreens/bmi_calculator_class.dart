...
class BmiCalculator{
  ...
  double getResults(){
    double metersInHeght = height/100;
    _bmi = weight/pow(metersInHeght, 2);
    print("Raw BMI: $_bmi");
  ...
  String getExplanations() {
    double _bmi = getResults();
    if (_bmi < 18.5) {
      return 'Your BMI is low, indicating your weight is in the Low category for adults of your height.\n\n'
